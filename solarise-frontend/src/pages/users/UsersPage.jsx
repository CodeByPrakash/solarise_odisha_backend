                      ...
                      <Table.Cell>
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="cursor-pointer px-3 py-1 bg-orange-200 hover:bg-slate-200 text-slate-700 text-xs font-bold rounded-full border border-slate-200/80 transition"
                          >
                            Edit
                          </button>
